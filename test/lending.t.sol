...
contract Testx is Test {
    ...
    function supplyUSDCDepositUser1() private { // usdc 100000000 ether deposit
    ...
    function supplySmallEtherDepositUser2() private {  // 1 ether deposit
        vm.deal(user2, 100000000 ether);
        vm.startPrank(user2);
    ...
    function testWithdrawLockedCollateralAfterBorrowSucceeds() external {
        supplyUSDCDepositUser1();  // usdc 100000000 ether
        supplySmallEtherDepositUser2(); // 1 ether
    ...
    function testExchangeRateChangeAfterUserBorrows() external {
        ...
        supplyUSDCDepositUser1();  // usdc 100000000 ether
        supplySmallEtherDepositUser2(); // eth 1 ether
    ...
    function testLiquidationHealthyLoanAfterPriorLiquidationFails() external {
        supplyUSDCDepositUser1(); // 100000000 ether
        supplySmallEtherDepositUser2(); // 
